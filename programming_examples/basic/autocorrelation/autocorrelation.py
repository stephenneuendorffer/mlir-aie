...
def autocorrelation(input:Sequence[int], output:Sequence[int], size:int):
    acc = 1
...
def test_model(input0, params, output):
    ...
    test_kernel = PyKernel(autocorrelation)
...
def main():
    ...
    test_model(smoothed_input, params, output)

    golden_output = iron.zeros_like(smoothed_input)
    autocorrelation(smoothed_input, golden_output, 512)

    # Check the correctness of the result
    e = np.equal(golden_output.numpy(), output.numpy())
